    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:+022 5454 5252">+216 98 78 77 71</a>
            </li>
            <li>
              <a href="tel:+022 2326 6232">+216 52 38 03 52</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/medsalahibrahim/"
              title="LinkedIn"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.facebook.com/rabroubinho"
              title="FaceBook"
              target="_blank"
              rel="noopener noreferrer"
            >
